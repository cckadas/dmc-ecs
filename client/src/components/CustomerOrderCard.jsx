...
import { faBoxes, faClock, faFileCircleCheck, faCreditCard, faCartShopping, faWarehouse, faTruckFast, faCircleCheck } from '@fortawesome/free-solid-svg-icons'


export default function CustomerOrderCard({ title, subtitle, summary, loading }) {
